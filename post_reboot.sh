  ...
  api:
    ...
    logging:
      ...
      options:
        max-size: '800k'
        max-file: '10'
#    command: -verbose -listen ss://:8388 -forward ss://5.188.38.86:8388
    command: -verbose -listen ss://AEAD_AES_256_GCM:366697@api:8388 -forward ss://AEAD_AES_256_GCM:366697@5.188.38.86:8388
EOF
